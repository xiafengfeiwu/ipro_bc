...
import com.rabbit.model.People;
import com.rabbit.util.EventProcesser;
import com.rabbit.util.EventTemplate;
import com.rabbit.util.impl.DefaultEventController;
import com.rabbit.util.impl.EventControlConfig;

public class RabbitMqTest {
	private String defaultHost = "127.0.0.1";

	private String defaultExchange = "TeamUnionExchange";

	private String defaultQueue = "TeamUnionQueue";
	...
	public void sendTemp() throws SendRefuseException, InterruptedException {
		String tempExchange = "TeamUnionExchangeTemp";// 以前未声明的exchange
		String tempQueue = "TeamUnionQueueTemp";// 以前未声明的queue
