        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="sys/menu" class="J_menuItem"><i class="fa fa-home"></i><span class="nav-label">主页</span></a>
                    </li>
                                ...
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <strong>小四</strong> <br> 这个在日本投降书上签字的军官，建国后一定是个不小的干部吧？<br>
        ...
        <div id="right-sidebar">
            <div class="sidebar-container">
                <ul class="nav nav-tabs navs-3">
                    <li class="active">
                        <a data-toggle="tab" href="#tab-theme"><i class="fa fa-gear"></i> 主题</a>
                    </li>
                </ul>
                    ...
                    <div id="tab-theme" class="tab-pane active">
                        ...
                        <div class="skin-setttings">
                            ...
                            <div class="setings-item blue-skin nb">
                                <span class="skin-name "><a href="javascript:;" class="s-skin-1">蓝色 主题</a></span>
                            </div>
                            <div class="setings-item yellow-skin nb">
                                <span class="skin-name ">
			                        <a href="javascript:;" class="s-skin-3">黄/紫色 主题</a>
                    			</span>
                            </div>
                        </div>
                    </div>
